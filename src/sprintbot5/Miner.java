...
//        if(rc.getID() == 10611 && rc.getRoundNum() == 140){
//            System.out.println("Lead mineable: " + leadMineable);
//            System.out.println("Num teammates: " + numTeammates);
//            System.out.println("Num enemies: " + numEnemies);
//        }
        if(leadMineable == 0){
            return -numEnemies * 3;
        }
        return (leadMineable - numTeammates - numEnemies * 3) / cooldown; // Larger heuristic is better
//        return (leadMineable - numTeammates * 2) / cooldown; // Larger heuristic is better
    }
