...
//        }
        ...
        if(!movedTowardsGold) {
            ...
            if(numDangerousEnemies > 5){ // Retreat!
                ...
                double currHeuristic = getHeursitic(myLoc, nearbyEnemies, isOffensive); // Costs 500 bytecode
//            System.out.println("CH: " + currHeuristic);
                ...
                if(currHeuristic != 0){
                    ...
                    for (int i = 0; i < Util.directions.length; i++) { // If you can move to a better spot, do so
                        ...
                        double newHeuristic = getHeursitic(newLoc, nearbyEnemies, isOffensive);
...
//        System.out.println("Friendly HP: " + friendlyHP + ", DMG: " + friendlyDamage + ", Enemy HP: " + enemyHP + ", DMG: " + enemyDamage);
    ...
    // 300 bytecode method
    public double getHeursitic(MapLocation center, RobotInfo[] nearbyEnemies, boolean isOffensive) throws GameActionException { // 1000 bytecode
