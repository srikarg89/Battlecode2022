...
public class BFS20{
    ...
    Direction runBFSNorth(MapLocation target) throws GameActionException{
        ...
        try{ double sum;if(rc.onTheMap(l44)){
            ...
            double tempDist;
            tempDist = v53/10;
            currScore = l53.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d53;
            }
            tempDist = v43/10;
            currScore = l43.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d43;
            }
            tempDist = v63/10;
            currScore = l63.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d63;
            }
            tempDist = v33/10;
            currScore = l33.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d33;
            }
            tempDist = v73/10;
            currScore = l73.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d73;
            }
            tempDist = v23/10;
            currScore = l23.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d23;
            }
            tempDist = v83/10;
            currScore = l83.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d83;
            }
    ...
    Direction runBFSSouth(MapLocation target) throws GameActionException{
        ...
        try{ double sum;if(rc.onTheMap(l44)){
            ...
            double tempDist;
            tempDist = v55/10;
            currScore = l55.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d55;
            }
            tempDist = v45/10;
            currScore = l45.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d45;
            }
            tempDist = v65/10;
            currScore = l65.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d65;
            }
            tempDist = v35/10;
            currScore = l35.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d35;
            }
            tempDist = v75/10;
            currScore = l75.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d75;
            }
            tempDist = v25/10;
            currScore = l25.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d25;
            }
            tempDist = v85/10;
            currScore = l85.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d85;
            }
    ...
    Direction runBFSEast(MapLocation target) throws GameActionException{
        ...
        try{ double sum;if(rc.onTheMap(l44)){
            ...
            double tempDist;
            tempDist = v44/10;
            currScore = l44.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d44;
            }
            ...
            tempDist = v42/10;
            currScore = l42.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d42;
            }
            tempDist = v46/10;
            currScore = l46.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d46;
            }
            tempDist = v41/10;
            currScore = l41.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d41;
            }
            tempDist = v47/10;
            currScore = l47.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d47;
            }
    ...
    Direction runBFSWest(MapLocation target) throws GameActionException{
        ...
        try{ double sum;if(rc.onTheMap(l44)){
            ...
            double tempDist;
            tempDist = v64/10;
            currScore = l64.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d64;
            }
            ...
            tempDist = v62/10;
            currScore = l62.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d62;
            }
            tempDist = v66/10;
            currScore = l66.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d66;
            }
            tempDist = v61/10;
            currScore = l61.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d61;
            }
            tempDist = v67/10;
            currScore = l67.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d67;
            }
    ...
    Direction runBFSNortheast(MapLocation target) throws GameActionException{
        ...
        try{ double sum;if(rc.onTheMap(l44)){
            ...
            tempDist = v34/10;
            currScore = l34.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d34;
            }
            tempDist = v52/10;
            currScore = l52.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d52;
            }
            tempDist = v24/10;
            currScore = l24.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d24;
            }
            tempDist = v51/10;
            currScore = l51.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d51;
            }
    ...
    Direction runBFSNorthwest(MapLocation target) throws GameActionException{
        ...
        try{ double sum;if(rc.onTheMap(l44)){
            ...
            tempDist = v74/10;
            currScore = l74.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d74;
            }
            ...
            tempDist = v84/10;
            currScore = l84.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d84;
            }
    ...
    Direction runBFSSoutheast(MapLocation target) throws GameActionException{
        ...
        try{ double sum;if(rc.onTheMap(l44)){
            ...
            tempDist = v56/10;
            currScore = l56.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d56;
            }
            ...
            tempDist = v57/10;
            currScore = l57.distanceSquaredTo(target) + tempDist*tempDist;
            if(currScore < bestScore){
                bestScore = currScore;
                ans = d57;
            }
