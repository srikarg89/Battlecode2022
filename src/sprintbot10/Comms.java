...
//    final int MINER_INSTRUCTION_START_IDX = 19; // 19-22
//    final int CLOSEST_ENEMY_MINER_LOC_IDX = 23;
//    final int CLOSEST_ENEMY_MINER_DIST_IDX = 24;
...
//    }
//
//    public void updateClosestEnemyTroop(MapLocation closestFriendlyArchon, MapLocation closestEnemyArchon, RobotInfo[] nearby) throws GameActionException {
//        int currDist = rc.readSharedArray(CLOSEST_ENEMY_MINER_DIST_IDX);
//        MapLocation currLoc = Util.intToMapLocation(rc.readSharedArray(CLOSEST_ENEMY_MINER_LOC_IDX));
//        if(rc.canSenseLocation(currLoc)){
//            RobotInfo currInfo = rc.senseRobotAtLocation(currLoc);
//            if(currInfo == null || currInfo.team == robot.myTeam){
//                currDist = 0;
//                currLoc = null;
//            }
//        }
...
//            if(info.type != RobotType.MINER || info.team != robot.myTeam.opponent()){
//                continue;
//            }
//            int friendlyDist = closestFriendlyArchon.distanceSquaredTo(info.location);
//            int dist = friendlyDist + 4000;
//            if(closestEnemyArchon != null){
//                dist += closestEnemyArchon.distanceSquaredTo(info.location);
//            }
//            if(dist > bestDist){
//                bestDist = dist;
...
//            writeSharedArray(CLOSEST_ENEMY_MINER_DIST_IDX, bestDist);
//            writeSharedArray(CLOSEST_ENEMY_MINER_LOC_IDX, Util.mapLocationToInt(bestLoc));
//        }
//        else{
//            writeSharedArray(CLOSEST_ENEMY_MINER_DIST_IDX, currDist);
//            if(currLoc == null){
//                writeSharedArray(CLOSEST_ENEMY_MINER_LOC_IDX, 0);
//            }
//            else{
//                writeSharedArray(CLOSEST_ENEMY_MINER_LOC_IDX, Util.mapLocationToInt(currLoc));
//            }
//        }
//
//    }
//
//    public MapLocation getClosestEnemyTroop() throws GameActionException {
//        int currDist = rc.readSharedArray(CLOSEST_ENEMY_MINER_DIST_IDX);
//        int currLocInt = rc.readSharedArray(CLOSEST_ENEMY_MINER_LOC_IDX);
//        if(currDist > 0){
//            return Util.intToMapLocation(currLocInt);
//        }
//        return null;
//    }
//
